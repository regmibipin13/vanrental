...
@section('content')
    <div class="flex items-center justify-center h-screen">
        <div class="bg-white p-8 rounded-lg text-center max-w-md w-full">
            ...
            <!-- Reservation Text -->
            <h2 class="text-2xl font-bold mb-2">Reservation is booked</h2>
            <p class="text-gray-600 mb-6">You Reservation has been done successfully under booking id {{ $booking->id }}.
            </p>

            <!-- Button -->
            <button class="bg-black text-white px-6 py-3 rounded-md font-semibold hover:bg-gray-800">
                <a href="{{ route('frontend.bookings') }}">Go to my Reservations</a>
            </button>
        </div>
    </div>
@endsection
