...
@section('content')
    <div class="flex items-center justify-center h-screen">
        <div class="bg-white p-8 rounded-lg max-w-md w-full">
            <h2 class="text-2xl font-bold mb-6 text-left">Login to Continue</h2>
            ...
            <div class="space-y-4">
                <button
                    ...
                    <a href="{{ route('social.login', 'google') }}">Continue with Google</a>
                </button>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <button type="submit" class="w-full bg-black hover:bg-gray-900 text-white py-3 rounded-lg">Login</button>
            </form>

            <!-- Forgot Password -->
            <div class="mt-4 text-center">
                <a href="#" class="text-blue-500 hover:underline">Forgot your password?</a><br>
                <span>Dont have account? <a href="{{ route('register') }}"
                        class="text-blue-500 hover:underline">Signup</a></span>
            </div>
        </div>
    </div>
@endsection
