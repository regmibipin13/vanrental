    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.testimonials.update", [$testimonial->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rent_details') ? 'is-invalid' : '' }}" type="text" name="rent_details" id="rent_details" value="{{ old('rent_details', $testimonial->rent_details) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('review') ? 'is-invalid' : '' }}" name="review" id="review" required>{{ old('review', $testimonial->review) }}</textarea>
